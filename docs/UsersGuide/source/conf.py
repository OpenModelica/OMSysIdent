...
latex_documents = [
  ('index', 'OMSysIdent.tex', u'OMSysIdent Documentation',
   u'OSMC', 'manual'),
]
...
man_pages = [
    ('index', 'OMSysIdent', u'OMSysIdent Documentation',
     [u'OSMC'], 1)
]
...
texinfo_documents = [
  ('index', 'OMSysIdent', u'OMSysIdent Documentation',
   u'OSMC', 'OMSysIdent', 'One line description of project.',
   'Miscellaneous'),
]
